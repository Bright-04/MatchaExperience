		...
		<div className="flex flex-col items-center">
			...
			<div className="hero w-full py-16 px-4 sm:px-6 lg:px-8 text-center">
				<div className="max-w-7xl mx-auto">
					<h1 className="text-4xl md:text-5xl font-bold text-primary-dark dark:text-primary-light mb-4 font-serif">The Rich History of Matcha</h1>
				...
				<div className="max-w-4xl mx-auto">
					<div className="border-l-4 border-primary ml-6">
						...
						<div className="relative mb-16">
							<div className="absolute -left-9 mt-2 w-14 h-14 rounded-full bg-primary-light/20 dark:bg-primary/20 border-4 border-primary flex items-center justify-center">
						...
						<div className="relative mb-16">
							...
							<div className="ml-12">
								<h3 className="text-2xl font-bold text-primary-dark dark:text-primary-light mb-2 font-serif">Sen no Rikyū and Tea Ceremony</h3>
								<p className="text-primary-dark/80 dark:text-primary-light/80 mb-4">
						...
						<div className="relative mb-16">
							...
							<div className="ml-12">
								<h3 className="text-2xl font-bold text-primary-dark dark:text-primary-light mb-2 font-serif">Modern Cultivation Methods</h3>
								<p className="text-primary-dark/80 dark:text-primary-light/80 mb-4">
						...
						<div className="relative">
							...
							<div className="ml-12">
								<h3 className="text-2xl font-bold text-primary-dark dark:text-primary-light mb-2 font-serif">Global Popularity</h3>
								<p className="text-primary-dark/80 dark:text-primary-light/80 mb-4">
			...
			<div className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-primary-light/10 dark:bg-primary-dark/20">
				<div className="max-w-7xl mx-auto">
					<h2 className="text-3xl font-bold text-center text-primary-dark dark:text-primary-light mb-12 font-serif">The Cultural Significance of Matcha</h2>

					<div className="grid grid-cols-1 md:grid-cols-2 gap-12">
						<div className="bg-white dark:bg-primary-dark/30 p-8 rounded-lg shadow-md dark:shadow-xl">
							<h3 className="text-xl font-bold text-primary-dark dark:text-primary-light mb-4 font-serif">Spiritual Connections</h3>
							<p className="text-primary-dark/80 dark:text-primary-light/80 mb-4">
						...
						<div className="bg-white dark:bg-primary-dark/30 p-8 rounded-lg shadow-md dark:shadow-xl">
							<h3 className="text-xl font-bold text-primary-dark dark:text-primary-light mb-4 font-serif">Artistic Influence</h3>
							<p className="text-primary-dark/80 dark:text-primary-light/80 mb-4">
